...
<WindowTopBar>
    <div class="flex items-center h-full gap-1">
     ...
     onclick={() => {if (back) fileSystem.back()}}>
     ...
     onclick={() => {if (forward) fileSystem.forward()}}>
        ...
        <div use:scrollset class="select-none text-nowrap no-scrollbar flex-1 mx-1 bg-gray-200 p-0.5 rounded-md px-2  overflow-x-auto">
